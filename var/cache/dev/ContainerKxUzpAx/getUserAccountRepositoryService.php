...
// Returns the private 'App\Repository\UserAccountRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/UserAccountRepository.php';

return $this->privates['App\Repository\UserAccountRepository'] = new \App\Repository\UserAccountRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
