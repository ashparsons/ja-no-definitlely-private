...
$a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\AnswerRepository' => function () {
    return ($this->privates['App\Repository\AnswerRepository'] ?? $this->load('getAnswerRepositoryService.php'));
...
}, 'App\\Repository\\UserAccountRepository' => function () {
    return ($this->privates['App\Repository\UserAccountRepository'] ?? $this->load('getUserAccountRepositoryService.php'));
}))));
