...
class Category extends \App\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
     ...
     */
    public static $lazyPropertiesDefaults = ['category_name' => NULL, 'questions' => NULL];
    ...
    {
        unset($this->category_name, $this->questions);
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'category_name', 'questions'];
        }
     ...
     * {@inheritDoc}
     */
    public function setCategoryName(string $category_name): \App\Entity\Category
    {
